...
describe('Login Service', () => {
  ...
  afterEach(() => {
    userRepositoryMock.restore(); // Restoring the original userRepository function
    sessionCreateMock.restore(); // Restoring the original userRepository function
    sessionSaveMock.restore(); // Restoring the original userRepository function
  });
